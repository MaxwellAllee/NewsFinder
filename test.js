...
// we could also be getting all of the notes separately so as to avoid using populate, which can be expensive
  ...
  db.Note.create(req.body)
    .then(function(dbNote) {
      ...
      return db.article.findOneAndUpdate(
        { _id: req.params.id },
        // need to push to the array instead of overwriting everything that is in this field
